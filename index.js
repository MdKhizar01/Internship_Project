    ...
    con.connect((err)=>{
        if(err){
            ...
            con.query(query,[values],(err,result)=>{
                ...
                for(let i=0; i<cart.length; i++){
                    var query = "INSERT INTO order_items(id, order_id, product_id, product_name, product_price, product_image, product_quantity, order_date) VALUES ?"
                    var values = [
...
app.get('/verify_payment', function(req,res){
    ...
    app.get('/single_product',function(req,res){
        ...
        con.query("Select * From single_product WHERE id='"+id+"'", (err, result) => {
